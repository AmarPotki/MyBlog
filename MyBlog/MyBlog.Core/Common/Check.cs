    ...
    public static class Check
    {
        public static class Argument
        {
            ...
            public static void IsNotZeroOrNegative(int parameter, string parameterName)
            {
                if (parameter <= 0)
                {
                    throw new ArgumentOutOfRangeException(parameterName, "{0} cannot be negative or zero".FormatWith(parameterName));
                }
            }
            ...
            public static void IsNotNegative(int parameter, string parameterName)
            {
                if (parameter < 0)
                {
                    throw new ArgumentOutOfRangeException(parameterName, "{0} cannot be negative".FormatWith(parameterName));
                }
            }
